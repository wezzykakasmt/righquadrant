...
<body>
    ...
    <center><div class="" name="" id="profile"></div><br>

        <div class="" name="" id="usernamedisplay">username</div>
</center>
   
    <center style="margin-top: 250px;">

            
           <div class="form-group-profile"><a href="signout.php" style="text-decoration: none;">
