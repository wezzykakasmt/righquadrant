...
<li ><div class="form-group-profile" style="background: none;"><a href="profilecompletion.php" style="text-decoration: none;">
                <!-- <i class="bi bi-box-arrow-right"></i> -->
            <span class="profile" style="background: none;"><small style="background: none;"s>Update Profile</small></span> <h style="opacity: 0.6; color: purple;" ></a>
            </div> </li>
            
           <li><div class="form-group-profile" style="background: none;"><a href="signout.php" style="text-decoration: none;">
                <!-- <i class="bi bi-box-arrow-right"></i> -->
